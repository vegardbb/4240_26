        ...
        for (int y = 0; y < BOARD_SIZE; y++) {
            ...
            for (int x = 0; x < BOARD_SIZE; x++) {
                ...
                if (d < 65 - ladderUpProb*fieldNr){
                    Field field = new NormalField(fieldNr, xPos, yPos, FIELD_WIDTH);
                    ...
                    if ((random <= chanceFieldProb) && (fieldNr > 0) && (remainingChanceFields > 0) &&  (fieldNr < FIELD_COUNT - 1)) {    // generate chancefield.
                        ...
                        Field field = new ChanceField(fieldNr, xPos, yPos, FIELD_WIDTH);
                        board.addField(field);
                        ...
                        Field field = new LadderField(fieldNr, board.getBoardFields().get(m), xPos, yPos, FIELD_WIDTH);
                        board.addField(field);
                        ...
                        Field field = new LadderField(fieldNr, null, xPos, yPos, FIELD_WIDTH);
